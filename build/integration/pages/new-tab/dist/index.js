...
(() => {
  ...
  function j(n3, u4, t4, i5, r4, o4, e4, f4, c4, s5) {
    var a4, h4, p5, v5, y4, g5, m3, b3, C3, S2, M3, P4, I2, A4, H3, L2, T4, F4 = u4.type;
    ...
    n: if ("function" == typeof F4) try {
      ...
      if (h4.context = M3, h4.props = b3, h4.__P = n3, h4.__e = false, I2 = l.__r, A4 = 0, C3) {
        for (h4.state = h4.__s, h4.__d = false, I2 && I2(u4), a4 = h4.render(h4.props, h4.state, h4.context), H3 = 0; H3 < h4._sb.length; H3++) h4.__h.push(h4._sb[H3]);
        h4._sb = [];
      } else do {
        h4.__d = false, I2 && I2(u4), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
      } while (h4.__d && ++A4 < 25);
      h4.state = h4.__s, null != h4.getChildContext && (i5 = w(w({}, i5), h4.getChildContext())), C3 && !p5 && null != h4.getSnapshotBeforeUpdate && (g5 = h4.getSnapshotBeforeUpdate(v5, y4)), f4 = $(n3, d(L2 = null != a4 && a4.type === k && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u4, t4, i5, r4, o4, e4, f4, c4, s5), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && e4.push(h4), m3 && (h4.__E = h4.__ = null);
    } catch (n4) {
  ...
  function VisibilityMenu({ rows, variant = "popover" }) {
    const MENU_ID = g2();
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames.default)(VisibilityMenu_default.list, variant === "embedded" && VisibilityMenu_default.embedded) }, rows.map((row) => {
  ...
  function Customizer() {
    ...
    const MENU_ID = g2();
    const BUTTON_ID = g2();
    return /* @__PURE__ */ g("div", { class: Customizer_default.root, ref: dropdownRef }, /* @__PURE__ */ g(CustomizerButton, { buttonId: BUTTON_ID, menuId: MENU_ID, toggleMenu, buttonRef, isOpen }), /* @__PURE__ */ g("div", { id: MENU_ID, class: (0, import_classnames2.default)(Customizer_default.dropdownMenu, { [Customizer_default.show]: isOpen }), "aria-labelledby": BUTTON_ID }, /* @__PURE__ */ g(VisibilityMenuPopover, null, /* @__PURE__ */ g(VisibilityMenu, { rows: rowData, variant: "popover" }))));
  }
  function getItems() {
    const next = [];
    const detail = {
  ...
  function V2(n3, t4, e4) {
    ...
    }), n3.__c.__H = null), null != (n3 = g4({}, n3)).__c && (n3.__c.__P === e4 && (n3.__c.__P = t4), n3.__c = null), n3.__k = n3.__k && n3.__k.map(function(n4) {
      return V2(n4, t4, e4);
    })), n3;
  }
  function W(n3, t4, e4) {
  ...
  var T3, A3, F3, U, H2, q3, G2, J2, K, Q, X, en, cn3, ln, fn, an, sn;
  var init_compat_module = __esm({
    "../node_modules/preact/compat/dist/compat.module.js"() {
      ...
      l.diffed = function(n3) {
        ...
        null != e4 && "textarea" === n3.type && "value" in t4 && t4.value !== e4.value && (e4.value = null == t4.value ? "" : t4.value), cn3 = null;
      };
    }
  });
  ...
  function Tile_({ url: url4, faviconSrc, faviconMax, index, title, id, dropped }) {
    ...
    return /* @__PURE__ */ g(
      ...
      /* @__PURE__ */ g("div", { class: (0, import_classnames4.default)(Tile_default.icon, Tile_default.draggable) }, /* @__PURE__ */ g(ImageLoader, { faviconSrc: faviconSrc || "n/a", faviconMax: faviconMax || DDG_DEFAULT_ICON_SIZE, title, url: url4 })),
  ...
  function Placeholder() {
    ...
    return /* @__PURE__ */ g("div", { className: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("div", { className: (0, import_classnames4.default)(Tile_default.icon, Tile_default.placeholder) }), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  function PlusIconWrapper({ onClick }) {
    ...
    const { state, ref } = useItemState(`PLACEHOLDER-URL-${id}`, `PLACEHOLDER-ID-${id}`);
    return /* @__PURE__ */ g("div", { class: Tile_default.item, ref, "data-edge": "closestEdge" in state && state.closestEdge }, /* @__PURE__ */ g("button", { class: (0, import_classnames4.default)(Tile_default.icon, Tile_default.placeholder, Tile_default.plus), "aria-labelledby": id, onClick }, /* @__PURE__ */ g(PlusIcon, null)), /* @__PURE__ */ g("div", { class: Tile_default.text, id }, t4("favorites_add")), state.type === "is-dragging-over" && state.closestEdge ? /* @__PURE__ */ g("div", { class: Tile_default.dropper, "data-edge": state.closestEdge }) : null);
  }
  ...
  function Favorites({ gridRef, favorites: favorites2, expansion, toggle, openContextMenu, openFavorite, add }) {
    ...
    return /* @__PURE__ */ g("div", { class: (0, import_classnames5.default)(Favorites_default.root, !canToggleExpansion && Favorites_default.noExpansionBtn), "data-testid": "FavoritesConfigured" }, /* @__PURE__ */ g(
      VirtualizedGridRows,
      {
        WIDGET_ID,
  ...
  function DismissButton({ className, onClick }) {
    const { t: t4 } = useTypedTranslation();
    return /* @__PURE__ */ g("button", { class: (0, import_classnames7.default)(DismissButton_default.btn, className), onClick, "aria-label": t4("ntp_dismiss"), "data-testid": "dismissBtn" }, /* @__PURE__ */ g(Cross, null));
  }
  ...
  function NextStepsCardGroup({ types, expansion, toggle, action, dismiss }) {
    ...
    return /* @__PURE__ */ g("div", { class: (0, import_classnames10.default)(NextSteps_default.cardGroup, types.length <= 2 && NextSteps_default.noExpansionBtn), id: WIDGET_ID }, /* @__PURE__ */ g(NextStepsBubbleHeader, null), /* @__PURE__ */ g("div", { class: NextSteps_default.cardGrid }, alwaysShown.map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action })), expansion === "expanded" && types.length > 2 && types.slice(2).map((type) => /* @__PURE__ */ g(NextStepsCard, { key: type, type, dismiss, action }))), types.length > 2 && /* @__PURE__ */ g(
      "div",
      {
  ...
  function Heading({ expansion, trackerCompanies, onToggle, buttonAttrs = {} }) {
    ...
    )), recent === 0 && /* @__PURE__ */ g("p", { className: PrivacyStats_default.subtitle }, t4("stats_noActivity")), recent > 0 && /* @__PURE__ */ g("p", { className: (0, import_classnames11.default)(PrivacyStats_default.subtitle, PrivacyStats_default.uppercase) }, t4("stats_feedCountBlockedPeriod")));
  }
  ...
  init_preact_module();
  var i2;
  null != (i2 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : void 0) && i2.__PREACT_DEVTOOLS__ && i2.__PREACT_DEVTOOLS__.attachPreact("10.25.3", l, { Fragment: k, Component: x });
  ...
  function BackgroundConsumer({ browser }) {
    ...
    switch (background.kind) {
      case "default": {
        return /* @__PURE__ */ g("div", { className: BackgroundReceiver_default.root, "data-testid": "BackgroundConsumer", "data-background-kind": "default", "data-theme": browser });
      }
      case "hex": {
        return /* @__PURE__ */ g(
          "div",
      ...
      case "gradient": {
        const gradient = values.gradients[background.value];
        return /* @__PURE__ */ g(k, { key: "gradient" }, /* @__PURE__ */ g(
          "div",
          {
            class: BackgroundReceiver_default.root,
            "data-animate": "false",
      ...
      default: {
        ...
        return /* @__PURE__ */ g("div", { className: BackgroundReceiver_default.root });
      }
    }
  }
  ...
  // pages/new-tab/app/customizer/CustomizerProvider.js
  var CustomizerThemesContext = J({
    /** @type {import("@preact/signals").Signal<'light' | 'dark'>} */
    main: d3("light"),
    /** @type {import("@preact/signals").Signal<'light' | 'dark'>} */
    browser: d3("light")
  });
  var CustomizerContext = J({
  ...
  function CustomizerProvider({ service, initialData, children }) {
    ...
    return /* @__PURE__ */ g(CustomizerContext.Provider, { value: { data, select, upload, setTheme, deleteImage } }, /* @__PURE__ */ g(CustomizerThemesContext.Provider, { value: { main, browser } }, children));
  }
  ...
  function BackgroundSection({ data, onNav, onUpload, select }) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.section }, /* @__PURE__ */ g("h3", { class: CustomizerDrawerInner_default.sectionTitle }, "Background"), /* @__PURE__ */ g("ul", { class: (0, import_classnames14.default)(CustomizerDrawerInner_default.sectionBody, CustomizerDrawerInner_default.bgList), role: "radiogroup" }, /* @__PURE__ */ g("li", { class: CustomizerDrawerInner_default.bgListItem }, /* @__PURE__ */ g(
      DefaultPanel,
      {
  ...
  function ColorPanel(props) {
    ...
    ), /* @__PURE__ */ g("span", { id }, "Solid Colors"));
  }
  ...
  function BackgroundImagePanel(props) {
    ...
    const label = empty.value === true ? /* @__PURE__ */ g("span", { id }, "Add Background") : /* @__PURE__ */ g("span", { id }, "My Backgrounds");
    if (empty.value === true) {
      return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(
        "button",
        {
  ...
  function BrowserThemeSection(props) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.section }, /* @__PURE__ */ g("h3", { class: CustomizerDrawerInner_default.sectionTitle }, "Browser Theme"), /* @__PURE__ */ g("ul", { class: (0, import_classnames15.default)(CustomizerDrawerInner_default.sectionBody, CustomizerDrawerInner_default.themeList) }, /* @__PURE__ */ g("li", { class: CustomizerDrawerInner_default.themeItem }, /* @__PURE__ */ g(
      "button",
      {
      ...
      /* @__PURE__ */ g("span", { class: "sr-only" }, "Select light theme")
    ), "Light"), /* @__PURE__ */ g("li", { class: CustomizerDrawerInner_default.themeItem }, /* @__PURE__ */ g(
      "button",
      {
        class: CustomizerDrawerInner_default.themeButton,
        role: "radio",
      ...
      /* @__PURE__ */ g("span", { className: "sr-only" }, "Select dark theme")
    ), "Dark"), /* @__PURE__ */ g("li", { class: CustomizerDrawerInner_default.themeItem }, /* @__PURE__ */ g(
      "button",
      {
        class: CustomizerDrawerInner_default.themeButton,
        role: "radio",
      ...
      /* @__PURE__ */ g("span", { className: "sr-only" }, "Select system theme")
    ), "System")));
  }
  ...
  function VisibilityMenuSection() {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.section }, /* @__PURE__ */ g("h3", { class: CustomizerDrawerInner_default.sectionTitle }, "Sections"), /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sectionBody }, /* @__PURE__ */ g(VisibilityMenu, { rows: rowData, variant: "embedded" })));
  }
  ...
  function ColorSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames16.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "Solid Colors"), /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.sectionBody }, /* @__PURE__ */ g("div", { class: (0, import_classnames16.default)(CustomizerDrawerInner_default.bgList), role: "radiogroup", onClick }, /* @__PURE__ */ g(PickerPanel, { data, select }), /* @__PURE__ */ g(ColorGrid, { data }))));
  }
  ...
  function ColorGrid({ data }) {
    ...
    return /* @__PURE__ */ g(k, null, entries.map(([key, entry]) => {
  ...
  function PickerPanel({ data, select }) {
    ...
    ), /* @__PURE__ */ g("span", { class: (0, import_classnames16.default)(CustomizerDrawerInner_default.colorInputIcon, CustomizerDrawerInner_default.dynamicIconColor), "data-color-mode": modeSelected }, /* @__PURE__ */ g(Picker, null)));
  }
  ...
  function GradientSelection({ data, select, back }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames17.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "Gradients"), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(GradientGrid, { data })));
  }
  ...
  function GradientGrid({ data }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames17.default)(CustomizerDrawerInner_default.bgList) }, entries2.map(([key, entry]) => {
  ...
  function ImageSelection({ data, select, back, onUpload, deleteImage }) {
    ...
    return /* @__PURE__ */ g("div", null, /* @__PURE__ */ g("button", { type: "button", onClick: back, class: (0, import_classnames18.default)(CustomizerDrawerInner_default.backBtn, CustomizerDrawerInner_default.sectionTitle) }, /* @__PURE__ */ g(BackChevron, null), "My Backgrounds"), /* @__PURE__ */ g("div", { className: CustomizerDrawerInner_default.sectionBody, onClick }, /* @__PURE__ */ g(ImageGrid, { data, deleteImage, onUpload })));
  }
  function ImageGrid({ data, deleteImage, onUpload }) {
    ...
    return /* @__PURE__ */ g("ul", { className: (0, import_classnames18.default)(CustomizerDrawerInner_default.bgList) }, entries4.value.map((entry) => {
      ...
      ), /* @__PURE__ */ g(DismissButton, { className: CustomizerDrawerInner_default.deleteBtn, onClick: () => deleteImage(entry.id) }));
    }), /* @__PURE__ */ g("li", { className: CustomizerDrawerInner_default.bgListItem }, /* @__PURE__ */ g("button", { type: "button", onClick: onUpload }, "Add image")));
  }
  ...
  function CustomizerDrawerInner({ data, select, onUpload, setTheme, deleteImage }) {
    ...
    return /* @__PURE__ */ g("div", { class: CustomizerDrawerInner_default.root }, /* @__PURE__ */ g("header", { class: CustomizerDrawerInner_default.header }, /* @__PURE__ */ g("h2", null, "Customize"), /* @__PURE__ */ g("button", { onClick: close }, "Close")), state.value === "home" && /* @__PURE__ */ g(BackgroundSection, { data, onNav, onUpload, select }), state.value === "home" && /* @__PURE__ */ g(BrowserThemeSection, { data, setTheme }), state.value === "home" && /* @__PURE__ */ g(VisibilityMenuSection, null), state.value === "color" && /* @__PURE__ */ g(ColorSelection, { data, select, back }), state.value === "gradient" && /* @__PURE__ */ g(GradientSelection, { data, select, back }), state.value === "image" && /* @__PURE__ */ g(ImageSelection, { data, select, back, onUpload, deleteImage }));
  }
  ...
  function CustomizerConsumer() {
    ...
    return /* @__PURE__ */ g(CustomizerDrawerInner, { data, select, onUpload: upload, setTheme, deleteImage });
  }
  ...
  function App() {
    ...
    return /* @__PURE__ */ g(k, null, /* @__PURE__ */ g(BackgroundConsumer, { browser }), /* @__PURE__ */ g("div", { class: App_default.layout, ref: wrapperRef, "data-animating": animating, "data-drawer-visibility": visibility }, /* @__PURE__ */ g("main", { class: (0, import_classnames19.default)(App_default.main, App_default.mainScroller), "data-main-scroller": true, "data-theme": main }, /* @__PURE__ */ g("div", { class: App_default.content }, /* @__PURE__ */ g("div", { className: App_default.tube, "data-content-tube": true, "data-platform": platformName }, /* @__PURE__ */ g(WidgetList, null))), /* @__PURE__ */ g(CustomizerMenuPositionedFixed, null, customizerKind === "menu" && /* @__PURE__ */ g(Customizer, null), customizerKind === "drawer" && /* @__PURE__ */ g(
      CustomizerButton,
      {
        buttonId,
        menuId: drawerId,
      ...
      /* @__PURE__ */ g("div", { class: App_default.asideContent }, /* @__PURE__ */ g("div", { class: App_default.asideContentInner }, /* @__PURE__ */ g(CustomizerDrawer, { displayChildren })))
    )));
  }
  ...
  function customizerMockTransport({ read, write, broadcast }) {
