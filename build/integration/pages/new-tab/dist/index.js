...
(() => {
  ...
  function P(n3, l5, u4, t4, i5, o4, r4, f4, e4, c4, s5) {
    var a4, p5, y5, d5, w5, _5 = t4 && t4.__k || v, g6 = l5.length;
    for (u4.__d = e4, $(u4, l5, _5), e4 = u4.__d, a4 = 0; a4 < g6; a4++) null != (y5 = u4.__k[a4]) && (p5 = -1 === y5.__i ? h : _5[y5.__i] || h, y5.__i = a4, O(n3, y5, p5, i5, o4, r4, f4, e4, c4, s5), d5 = y5.__e, y5.ref && p5.ref != y5.ref && (p5.ref && N(p5.ref, null, y5), s5.push(y5.ref, y5.__c || d5, y5)), null == w5 && null != d5 && (w5 = d5), 65536 & y5.__u || p5.__k === y5.__k ? e4 = I(y5, e4, n3) : "function" == typeof y5.type && void 0 !== y5.__d ? e4 = y5.__d : d5 && (e4 = d5.nextSibling), y5.__d = void 0, y5.__u &= -196609);
    u4.__d = e4, u4.__e = w5;
  }
  function $(n3, l5, u4) {
  ...
  function O(n3, u4, t4, i5, o4, r4, f4, e4, c4, s5) {
    var a4, h5, v4, p5, w5, _5, g6, m4, x5, C4, S2, M3, $2, I2, H3, L3, T4 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t4.__u && (c4 = !!(32 & t4.__u), r4 = [e4 = u4.__e = t4.__e]), (a4 = l.__b) && a4(u4);
    n: if ("function" == typeof T4) try {
      if (m4 = u4.props, x5 = "prototype" in T4 && T4.prototype.render, C4 = (a4 = T4.contextType) && i5[a4.__c], S2 = a4 ? C4 ? C4.props.value : a4.__ : i5, t4.__c ? g6 = (h5 = u4.__c = t4.__c).__ = h5.__E : (x5 ? u4.__c = h5 = new T4(m4, S2) : (u4.__c = h5 = new k(m4, S2), h5.constructor = T4, h5.render = q), C4 && C4.sub(h5), h5.props = m4, h5.state || (h5.state = {}), h5.context = S2, h5.__n = i5, v4 = h5.__d = true, h5.__h = [], h5._sb = []), x5 && null == h5.__s && (h5.__s = h5.state), x5 && null != T4.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = d({}, h5.__s)), d(h5.__s, T4.getDerivedStateFromProps(m4, h5.__s))), p5 = h5.props, w5 = h5.state, h5.__v = u4, v4) x5 && null == T4.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), x5 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
      else {
        if (x5 && null == T4.getDerivedStateFromProps && m4 !== p5 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(m4, S2), !h5.__e && (null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(m4, h5.__s, S2) || u4.__v === t4.__v)) {
          for (u4.__v !== t4.__v && (h5.props = m4, h5.state = h5.__s, h5.__d = false), u4.__e = t4.__e, u4.__k = t4.__k, u4.__k.some(function(n4) {
            n4 && (n4.__ = u4);
          }), M3 = 0; M3 < h5._sb.length; M3++) h5.__h.push(h5._sb[M3]);
          h5._sb = [], h5.__h.length && f4.push(h5);
          break n;
        }
        null != h5.componentWillUpdate && h5.componentWillUpdate(m4, h5.__s, S2), x5 && null != h5.componentDidUpdate && h5.__h.push(function() {
          h5.componentDidUpdate(p5, w5, _5);
        });
      }
      if (h5.context = S2, h5.props = m4, h5.__P = n3, h5.__e = false, $2 = l.__r, I2 = 0, x5) {
        for (h5.state = h5.__s, h5.__d = false, $2 && $2(u4), a4 = h5.render(h5.props, h5.state, h5.context), H3 = 0; H3 < h5._sb.length; H3++) h5.__h.push(h5._sb[H3]);
        h5._sb = [];
      } else do {
        h5.__d = false, $2 && $2(u4), a4 = h5.render(h5.props, h5.state, h5.context), h5.state = h5.__s;
      } while (h5.__d && ++I2 < 25);
      h5.state = h5.__s, null != h5.getChildContext && (i5 = d(d({}, i5), h5.getChildContext())), x5 && !v4 && null != h5.getSnapshotBeforeUpdate && (_5 = h5.getSnapshotBeforeUpdate(p5, w5)), P(n3, y(L3 = null != a4 && a4.type === b && null == a4.key ? a4.props.children : a4) ? L3 : [L3], u4, t4, i5, o4, r4, f4, e4, c4, s5), h5.base = u4.__e, u4.__u &= -161, h5.__h.length && f4.push(h5), g6 && (h5.__E = h5.__ = null);
    } catch (n4) {
  ...
  function z(u4, t4, i5, o4, r4, f4, e4, c4, s5) {
    var a4, v4, p5, d5, _5, g6, m4, b4 = i5.props, k4 = t4.props, C4 = t4.type;
    ...
    if (null === C4) b4 === k4 || c4 && u4.data === k4 || (u4.data = k4);
    else {
      if (f4 = f4 && n.call(u4.childNodes), b4 = i5.props || h, !c4 && null != f4) for (b4 = {}, a4 = 0; a4 < u4.attributes.length; a4++) b4[(_5 = u4.attributes[a4]).name] = _5.value;
      for (a4 in b4) if (_5 = b4[a4], "children" == a4) ;
      else if ("dangerouslySetInnerHTML" == a4) p5 = _5;
      else if (!(a4 in k4)) {
        if ("value" == a4 && "defaultValue" in k4 || "checked" == a4 && "defaultChecked" in k4) continue;
        A(u4, a4, null, _5, r4);
      }
      for (a4 in k4) _5 = k4[a4], "children" == a4 ? d5 = _5 : "dangerouslySetInnerHTML" == a4 ? v4 = _5 : "value" == a4 ? g6 = _5 : "checked" == a4 ? m4 = _5 : c4 && "function" != typeof _5 || b4[a4] === _5 || A(u4, a4, _5, b4[a4], r4);
      ...
      c4 || (a4 = "value", "progress" === C4 && null == g6 ? u4.removeAttribute("value") : void 0 !== g6 && (g6 !== u4[a4] || "progress" === C4 && !g6 || "option" === C4 && g6 !== b4[a4]) && A(u4, a4, g6, b4[a4], r4), a4 = "checked", void 0 !== m4 && m4 !== u4[a4] && A(u4, a4, m4, b4[a4], r4));
    }
    return u4;
  }
  function N(n3, u4, t4) {
  ...
  function p4(i5) {
    ...
    var u4 = T2(function() {
      ...
      var f5 = w3(function() {
        ...
        var i7;
        return t(f5.value) || 3 !== (null == (i7 = n3.base) ? void 0 : i7.nodeType);
      });
      n3.__$u.c = function() {
        var i7;
        if (!t(u4.peek()) && 3 === (null == (i7 = n3.base) ? void 0 : i7.nodeType)) n3.base.data = u4.peek();
        else {
          n3.__$f |= 1;
          n3.setState({});
        }
      ...
      E(function() {
        if (!m2) m2 = this.N;
        this.N = A3;
        if (c4.value && i6.base) i6.base.data = f5.value;
      });
      return f5;
    }, []);
    return u4.value;
  }
  function _4(i5, n3, r4, t4) {
  ...
  function q3() {
    r3(function() {
      var i5;
      while (i5 = g4.shift()) m2.call(i5);
    });
  }
  function w4() {
    if (1 === g4.push(this)) (l.requestAnimationFrame || k3)(q3);
  }
  function x3() {
    r3(function() {
      var i5;
      while (i5 = b3.shift()) m2.call(i5);
    });
  }
  function A3() {
    if (1 === b3.push(this)) (l.requestAnimationFrame || y4)(x3);
  }
    ...
    "../node_modules/@preact/signals/dist/signals.module.js"() {
      ...
      d4("diffed", function(i5, n3) {
        ...
        if ("string" == typeof n3.type && (r4 = n3.__e)) {
          ...
          if (t4) {
            var o4 = r4.U;
            if (o4) for (var u4 in o4) {
              var e4 = o4[u4];
              if (void 0 !== e4 && !(u4 in t4)) {
                e4.d();
                o4[u4] = void 0;
              }
            }
      ...
      k.prototype.shouldComponentUpdate = function(i5, n3) {
        var r4 = this.__$u;
      ...
      g4 = [];
      b3 = [];
      k3 = "undefined" == typeof requestAnimationFrame ? setTimeout : requestAnimationFrame;
      y4 = function(i5) {
  ...
  function C3(n3, e4) {
    function r4(n4) {
      ...
      return !r5 && t4 && (t4.call ? t4(null) : t4.current = null), e4 ? !e4(this.props, n4) || !r5 : g5(this.props, n4);
    }
    function u4(e5) {
  ...
  var x4, R, N2, M2, U, j3, z3, B3, H2, Z, Y, G2, X, nn, tn, en, rn;
  var init_compat_module = __esm({
    "../node_modules/preact/compat/dist/compat.module.js"() {
      ...
      (E3.prototype = new k()).isPureReactComponent = true, E3.prototype.shouldComponentUpdate = function(n3, t4) {
        return g5(this.props, n3) || g5(this.state, t4);
      };
      x4 = l.__b;
      l.__b = function(n3) {
        n3.type && n3.type.__f && n3.ref && (n3.props.ref = n3.ref, n3.ref = null), x4 && x4(n3);
      };
      ...
      l.unmount = function(n3) {
        ...
        var c4 = function() {
          if (!--r4.__u) {
            if (r4.state.__a) {
              var n4 = r4.state.__a;
              r4.__v.__k[0] = A4(n4, n4.__c.__P, n4.__c.__O);
            }
            var t5;
